        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Businesses_Towns_TownId",
                        column: x => x.TownId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    HourlyPricePerPerson = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FieldSituations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FieldSituations_FootballFields_FootballFieldId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FieldSituationId = table.Column<int>(type: "int", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Updated = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_FieldSituations_FieldSituationId",
                        column: x => x.FieldSituationId,
                        principalTable: "FieldSituations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Businesses_TownId",
                table: "Businesses",
                column: "TownId");

            migrationBuilder.CreateIndex(
                name: "IX_FieldSituations_FootballFieldId",
                table: "FieldSituations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_FieldSituationId",
                table: "Reservations",
                column: "FieldSituationId",
                unique: true);
